...
var apiUrl = {
	...
	ApiTaskEdit: apiPrefix + "/task/update",
	...
	ApiTaskAssignUnitDetail: apiPrefix + "/taskassignUnit/detail/",
	...
	ApiinfosXlsDetail: apiPrefix + "/infos/detail",
	  // 区委信息删除
